...
+------+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------|------------------------------------------------|
| FHA  | Full bulk data available on request (update!)                                                        | `Pfau-Kempf+2025 (in review) <https://doi.org/10.5194/angeo-2024-26>`_                | EGI w/ ionosphere. Usable for tail RX processes|
